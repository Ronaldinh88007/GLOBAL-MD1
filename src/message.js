...
//TELEGRAM CHANNEL: https://t.me/Hub7s
		...
		for (let n of update) {
			...
			if (setinfo) {
				...
				try {
					...
					profile = 'https://i.imgur.com/Gw7jtD0.jpeg';
				}
				if (n.announce) {
	...
	try {
		...
		if (welcome) {
			...
			for (let n of participants) {
				...
				if (action == 'add') {
				let xeonName = n
                const xdate = moment.tz('Africa/Kenya').locale('en-KE').format('DD/MM/YYYY');
                const xtime = moment().tz('Africa/Kenya').locale('en-KE').format('HH:mm:ss');
...
await XeonBotInc.relayMessage(id, msgs.message, {})
				...
				let xeonName = n
                const xeondate = moment.tz('Africa/Kenya').locale('en-KE').format('DD/MM/YYYY');
                const xeontime = moment().tz('Africa/Karachi').locale('en-KE').format('HH:mm:ss');
...
const xeontime = moment().tz('Africa/Kenya').locale('en-KE').format('HH:mm:ss');
const xeondate = moment.tz('Africa/Kenya').locale('en-KE').format('DD/MM/YYYY');
let xeonName = n
